...
// Probably all code here should change acccordingly to the search engine to be integrated. Keeping it here for reference.
...
export const productsCatalog = async (searchResult: any, ctx: any) => {
  ...
  if (!isEmpty(productIds)) {
    ...
    // Maintain customSearchEngine's order.
    products = sort(
      (a, b) =>
