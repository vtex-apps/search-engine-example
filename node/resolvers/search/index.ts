...
export const queries = {
  ...
  facets: async (_: any, args: FacetsInput, ctx: any) => {
    ...
    const { customSearchEngine } = ctx.clients
    ...
    const result = await customSearchEngine.facets(biggyArgs)
  ...
  productSearch: async (_: any, args: ProductSearchInput, ctx: any) => {
    ...
    const result = await customSearchEngine.productSearch(biggyArgs)
